"""Phase-6 engine preserving world state while versioning observation policy."""
...
from finances_simulator.simulation.primitives import V5_PROFILE, make_run_id
from finances_simulator.simulation.v4 import simulate_v4


def _world_config(config: ScenarioConfigV5) -> ScenarioConfigV4:
...
def simulate_v5(
    ...
    *,
    ...
    """Reuse frozen V4 economics and attach independent V5 observation identity."""
    ...
    return replace(
        ...
        run_id=make_run_id(
            ...
            seed,
            base.months,
            simulator_version=V5_PROFILE.simulator_version,
        ),
