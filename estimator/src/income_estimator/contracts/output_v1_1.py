...
ESTIMATOR_OUTPUT_CONTRACT_VERSION_1_1 = "1.1"

QUANTILE_UNAVAILABLE_UNCALIBRATED = "UNCALIBRATED_INTERVAL"
QUANTILE_UNAVAILABLE_INSUFFICIENT_HISTORY = "INSUFFICIENT_HISTORY"

# Distinct from `UNCALIBRATED_INTERVAL`, which says this band has no fitted correction. This says
# the correction exists and does not apply here: the row sits outside the conditions the calibration
# was measured on, so the `80%` label would be wording without a measurement behind it.
QUANTILE_UNAVAILABLE_OUT_OF_SUPPORT = "OUT_OF_CALIBRATED_SUPPORT"
...
__all__ = [
    "ESTIMATOR_OUTPUT_CONTRACT_VERSION_1_1",
    "QUANTILE_UNAVAILABLE_INSUFFICIENT_HISTORY",
    "QUANTILE_UNAVAILABLE_OUT_OF_SUPPORT",
    "QUANTILE_UNAVAILABLE_REASONS",
    "QUANTILE_UNAVAILABLE_UNCALIBRATED",
