...
def test_explanation_traces_every_decision_and_version(
    ...
    assert explanation.estimator_version == "ensemble-0.8.0"
    assert explanation.output_contract_version == "1.2"
    assert "capacity-gbdt-stumps-0.7.0" in explanation.model_versions
    assert "conditional-selector-intervals-0.13.0" in explanation.model_versions
